...
Actividad Individual - IS-702 Analisis y Diseno de Sistemas
Estudiante: Jose Manuel Romero Martinez
"""
...
st.caption("IS-702 Analisis y Diseno de Sistemas | UNAH Campus Comayagua")
st.markdown("---")
...
if df is None:
    ...
    st.markdown(
        ...
        **Para usar esta aplicacion:**
        ...
        2. Coloca el archivo `train.csv` en la misma carpeta que `app.py`.
        3. Si estas desplegando en Streamlit Community Cloud, sube `train.csv`
...
n_muestra = st.sidebar.select_slider(
    "Tamano de muestra a usar", options=[3000, 5000, 8000, 12000, 20000], value=8000,
    help="Reduce este valor si la aplicacion tarda demasiado en entrenar."
)
...
st.markdown("---")
st.caption("Desarrollado para IS-702 | Analisis y Diseno de Sistemas | UNAH Campus Comayagua")
